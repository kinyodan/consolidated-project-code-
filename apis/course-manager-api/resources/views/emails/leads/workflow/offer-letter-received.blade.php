...
<table width="600" summary="The Craydel family!" bgcolor="#FFFFFF" border="0" align="center" cellpadding="0" cellspacing="0" class="email_container">
    ...
    <div style="display:none;font-size:1px;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;mso-hide:all;font-family: sans-serif;">
        Congratulations! This is happening!
    </div>
            ...
            <table width="100%" border="0">
                ...
                <tr>
                    ...
                    <td align="left" valign="top">
                        ...
                        <p style="color:#191919; font-family:'Helvetica Neue', Helvetica, Arial; font-size:15px; line-height: 20px; margin:0 0 15px; padding:0;">
                            We are super pleased to inform you on behalf of <b>{{ $institution_name }}</b> that your application for <b>{{ $course_name }}</b> has been accepted!
                        </p>

                        <p style="color:#191919; font-family:'Helvetica Neue', Helvetica, Arial; font-size:15px; line-height: 20px; margin:0 0 15px; padding:0;">
                            To secure your enrolment the institution has sent your offer letter along with fee details, so you can secure your admission.
                        </p>

                        <p style="color:#191919; font-family:'Helvetica Neue', Helvetica, Arial; font-size:15px; line-height: 20px; margin:0 0 15px; padding:0;">
                            We request that you take note of the deadline for fee submission, to continue your journey to owning your future.
                        </p>
