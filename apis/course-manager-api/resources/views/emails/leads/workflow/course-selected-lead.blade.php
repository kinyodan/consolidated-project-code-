...
<table width="600" summary="The Craydel family!" bgcolor="#FFFFFF" border="0" align="center" cellpadding="0" cellspacing="0" class="email_container">
    ...
    <div style="display:none;font-size:1px;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;mso-hide:all;font-family: sans-serif;">
        Congratulations on your first step towards a rewarding Higher Education journey!
    </div>
                ...
                <tr>
                    ...
                    <td align="left" valign="top">
                        ...
                        <p style="color:#191919; font-family:'Helvetica Neue', Helvetica, Arial; font-size:15px; line-height: 20px; margin:0 0 15px; padding:0;">
                            We are pleased that you have selected <b>{{ $course_name }}</b> at <b>{{ $institution_name }}</b>. in <b>{{ $country_name }}</b>!
                        </p>
                        ...
                        {{--<p style="color:#191919; font-family:'Helvetica Neue', Helvetica, Arial; font-size:15px; line-height: 20px; margin:0 0 15px; padding:0;">
                            We've noted that you have expressed interest in {{ $course_name }} course in {{ $country_name }} country. This is great! We have some amazing options for you!
                        </p>--}}
                        {{--<p style="color:#191919; font-family:'Helvetica Neue', Helvetica, Arial; font-size:15px; line-height: 20px; margin:0 0 15px; padding:0;">
                            Our expert admissions counsellor<b>{{ $counsellor_name }}</b> will contact you shortly on {!! $counsellor_phone_number !!} to discuss the details of your application process.
                        </p>--}}
                        <p style="color:#191919; font-family:'Helvetica Neue', Helvetica, Arial; font-size:15px; line-height: 20px; margin:0 0 15px; padding:0;">
                            Just to make your application process fast and smooth, please see below a list of the documents you should get ready
                        </p>

                        @if(isset($admission_requires))
                            ...
                            @foreach($admission_requires as $requirement)
                                <li>{{ $requirement }}</li>
                            @endforeach
                            </ul>
                        @endif
                        ...
                        <p style="color:#191919; font-family:'Helvetica Neue', Helvetica, Arial; font-size:15px; line-height: 20px; margin:0 0 15px; padding:0;">
                            All the very best {{ $student_first_name }}
                        </p>
