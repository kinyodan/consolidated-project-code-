...
<head>
    <meta charset="utf-8">
    <title>Welcome to the Craydel family!</title>
...
<table width="600" summary="Welcome to the Craydel family!" bgcolor="#FFFFFF" border="0" align="center" cellpadding="0" cellspacing="0" class="email_container">
    ...
    <div style="display:none;font-size:1px;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;mso-hide:all;font-family: sans-serif;">
        Your journey to your awesome career has now started!
    </div>
                ...
                <tr>
                    ...
                    <td align="left" valign="top">
                        ...
                        <p style="color:#191919; font-family:'Helvetica Neue', Helvetica, Arial; font-size:15px; line-height: 20px; margin:0 0 15px; padding:0;">
                            This is really exciting! Your journey to your awesome career has now started!
                        </p>

                        <p style="color:#191919; font-family:'Helvetica Neue', Helvetica, Arial; font-size:15px; line-height: 20px; margin:0 0 15px; padding:0;">
                            Welcome to Craydel; we are delighted to serve you plan your higher education journey!
                        </p>
                        <p style="color:#191919; font-family:'Helvetica Neue', Helvetica, Arial; font-size:15px; line-height: 20px; margin:0 0 15px; padding:0;">
                            We founded Craydel to exponentially improve your experience in choosing the right career and applying to top universities and vocational colleges across Africa and the world!
                        </p>
                        <p style="color:#191919; font-family:'Helvetica Neue', Helvetica, Arial; font-size:15px; line-height: 20px; margin:0 0 15px; padding:0;">
                            Throughout your journey with Craydel, our admission counsellor assigned to you will assist you in every step of the way
                        </p>
                        <p style="color:#191919; font-family:'Helvetica Neue', Helvetica, Arial; font-size:15px; line-height: 20px; margin:0 0 15px; padding:0;">
                            We'd like to thank you for signing up with us and look forward to guiding you through this next step in your career journey!
                        </p>
