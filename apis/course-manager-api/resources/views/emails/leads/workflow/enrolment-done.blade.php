...
<table width="600" summary="The Craydel family!" bgcolor="#FFFFFF" border="0" align="center" cellpadding="0" cellspacing="0" class="email_container">
    ...
    <div style="display:none;font-size:1px;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;mso-hide:all;font-family: sans-serif;">
        Congratulations on enrolling to {{ $institution_name }} for {{ $course_name }}!
    </div>
                ...
                <tr>
                    ...
                    <td align="left" valign="top">
                        ...
                        <p style="color:#191919; font-family:'Helvetica Neue', Helvetica, Arial; font-size:15px; line-height: 20px; margin:0 0 15px; padding:0;">
                            Congratulations on enrolling to <b>{{ $institution_name }}</b> for <b>{{ $course_name }}</b>!
                        </p>

                        <p style="color:#191919; font-family:'Helvetica Neue', Helvetica, Arial; font-size:15px; line-height: 20px; margin:0 0 15px; padding:0;">
                            This is your first of many steps in your career journey and we're happy to have been a part of it.
                        </p>

                        <p style="color:#191919; font-family:'Helvetica Neue', Helvetica, Arial; font-size:15px; line-height: 20px; margin:0 0 15px; padding:0;">
                            Thank you so much! It's been a pleasure & an honour!
                        </p>

                        <p style="color:#191919; font-family:'Helvetica Neue', Helvetica, Arial; font-size:15px; line-height: 20px; margin:0 0 15px; padding:0;">
                            As for next steps, we would get in touch with you for a Pre-Departure Session. The date and time will be agreed with you based on your availability
                        </p>
