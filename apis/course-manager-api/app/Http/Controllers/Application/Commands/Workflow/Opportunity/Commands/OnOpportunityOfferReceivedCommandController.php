...
class OnOpportunityOfferReceivedCommandController
{
    use CanSendEmail;

    /**
     * Process the opportunity after the user moves the opportunity to offer letter received
     *
            ...
            if(!empty($opportunity_contact_id) && !empty($course_name) && !empty($institution_name)){
                ...
                if(!empty($contact_email)){
                    ...
                    (new self())->sendEmail(
                        ...
                        $contact_email,
                        sprintf(
                            LanguageTranslationHelper::translate('course_application.workflow.notifications.course_application_offer_received'),
                            !empty($contact_name) ? " ".$contact_name : ""
                        ),
                        view('emails.leads.workflow.offer-letter-received',[
