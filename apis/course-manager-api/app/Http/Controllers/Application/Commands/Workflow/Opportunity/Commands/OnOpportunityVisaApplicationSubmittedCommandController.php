...
class OnOpportunityVisaApplicationSubmittedCommandController
{
    use CanSendEmail;

    /**
     * Process the opportunity after the user moves the opportunity to Visa Application Submitted
     *
    ...
    protected static function review(?object $opportunity){
        ...
        $is_missing_course_requirements = call_user_func(function () use($course_name, $Deposit_Amount_Paid, $institution_name, $study_destination, $level_of_study_are_you_applying_for, $Visa_is_required){
