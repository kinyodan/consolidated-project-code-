...
class CraydelCourseIndexListItemType
{
    use CanLog;

    /**
     * @var string|null $indexing_object_id
     */
    private ?string $indexing_object_id;
    ...
    */
     ...
     * @return string|null
     */
    public function getIndexingObjectId(): ?string
    {
        return $this->indexing_object_id;
    }

    /**
     * @param string|null $indexing_object_id
     */
    public function setIndexingObjectId(?string $indexing_object_id): void
    {
        $this->indexing_object_id = $indexing_object_id;
    }
     ...
     * @return CraydelCourseIndexListItemType
     */
    public function setStandardFeeBillingType(?string $standard_fee_billing_type): CraydelCourseIndexListItemType
    {
    ...
    {
        $this->course = DB::table((new CourseSearchIndexList())->getTable())
            ->where('id', trim($id))
            ->first();
