...
class CreateClusterSubjectCommandController
{
    ...
    public function create(Request $request): JsonResponse
    {
        try {
            ...
            foreach ($subjects as $subject) {
                DB::table('cluster_subjects')->insertOrIgnore([
                    ['cluster_id' => $cluster_id, 'subject_id' => $subject, 'education_type_id' => $education_type_id,
                        'country_id' => $country_id, 'is_primary' => $is_primary,
