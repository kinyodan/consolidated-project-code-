...
trait CanUploadImage
{
    ...
    */
     ...
     *
     */
    private static function uploadImage(string $staged_file_path, Model $modelToUpdateAfterUpload, array $sizesToCreate, ?string $model_temp_file_column = 'temp_logo_path')
    {
        try{
     ...
     * @return void
     */
    public static function _deleteFromCDN(string $filePath){
        try{
