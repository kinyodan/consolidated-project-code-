<template>
  <div class="modal fade in" id="bulk_deactivate_users" tabindex="-1">
    <div class="modal-dialog create_new_event">
      <div class="modal-content">
        <div class="modal-content-inner">
          <div class="modal_header">
            <h2 class="modal_title">Deactivate Users in Bulk</h2>
          ...
          <div v-show="!firstLoad">
            ...
            <div class="action_btns modal_footer">
              <a class="edit_btn" @click="deactivateItem">Deactivate Users</a>
              <a href="" class="cancel_btn" data-dismiss="modal">Cancel</a>
            </div>
          </div>

          <v-dialog v-model="dialogDeactivate" :retain-focus="false" content-class="dialog">
            <v-card>
              <v-card-title class="text-h6 text-center">Are you sure you want to deactivate { count } users?
              </v-card-title>
              <v-card-actions>
                <v-spacer></v-spacer>
                <v-btn color="blue" text @click="closeDeactivate">Cancel</v-btn>
                <v-btn color="error" text @click="deactivateItemConfirm">OK</v-btn>
                <v-spacer></v-spacer>
              </v-card-actions>
            </v-card>
          </v-dialog>
...
export default {
  ...
  methods: {
    ...
    deactivateItemConfirm() {
      ...
      $('#bulk_deactivate_users').modal('hide');
    },
