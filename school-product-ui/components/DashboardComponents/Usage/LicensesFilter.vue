<template>
  <div class="modal fade in" id="filter_licenses" tabindex="-1">
    <div class="modal-dialog create_new_event">
      <div class="modal-content">
        <div class="modal-content-inner">
          <div class="modal_header">
            <h2 class="modal_title">Filter Licenses Purchased</h2>
          ...
          <div class="full_width">
            <div class="form_group autocomplete">
              <label class="form_label" for="filter_purchase_date">Date of Purchase</label>
              <input type="date" id="filter_purchase_date">
            </div>
          </div>
...
export default {
  ...
  data() {
    return {
      ...
      filter_careers: ['Career 1', 'Career 2', 'Career 3'],
    }
  },
  computed: {
