<template>
  <div class="modal fade in" id="show_licenses_details" tabindex="-1">
    <div class="modal-dialog create_new_event">
      <div class="modal-content full-width">
        <div class="modal-content-inner">
          <div class="modal_header">
            <h2 class="modal_title">Licenses Purchased</h2>
              ...
              >
                ...
                <template v-slot:expanded-item="{ headers, item, isMobile }">
                  <td :colspan="headers.length" class="school-grid-mobile" v-if="isMobile">
                    ...
                    <div class="school-grid-mobile__row">
                      <div class="v-data-table__mobile-row__header">Date of Purchase</div>
                      <div class="v-data-table__mobile-row__cell">{{ new Date(item.purchase_date).toLocaleDateString() }}</div>
                    </div>
                    <div class="school-grid-mobile__row">
...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        ...
        {text: 'Date of Purchase', value: 'purchase_date'},
      ],
  ...
  methods: {
      ...
      this.students = [
        {
          ...
          student_stream: 'A',
          purchase_date: new Date('2022-01-13'),
        },
        {
          id: 2,
        ...
        },
        {
          ...
          student_stream: 'Y',
          purchase_date: new Date('2022-02-24'),
        },
        {
          id: 4,
          ...
          student_stream: 'A',
          purchase_date: new Date('2022-03-03'),
        },
        {
          id: 5,
          ...
          student_class: 'Form 4',
          student_stream: 'B',
          purchase_date: new Date('2022-04-16'),
        },
      ]
    },
    ...
    closeModal() {
      $('#show_licenses_details').modal('hide');
    },
  },
}
</script>
