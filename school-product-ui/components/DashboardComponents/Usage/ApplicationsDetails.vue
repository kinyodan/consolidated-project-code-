<template>
  <div class="modal fade in" id="show_applications_details" tabindex="-1">
    <div class="modal-dialog create_new_event">
      <div class="modal-content full-width">
        <div class="modal-content-inner">
          <div class="modal_header">
            <h2 class="modal_title">Applications Done</h2>
...
export default {
  ...
  methods: {
    ...
    closeModal() {
      $('#show_applications_details').modal('hide');
    },
  },
}
</script>
