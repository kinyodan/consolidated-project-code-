<template>
  <div class="modal fade in" id="filter_assessments" tabindex="-1">
    <div class="modal-dialog create_new_event">
      <div class="modal-content">
        <div class="modal-content-inner">
          <div class="modal_header">
            <h2 class="modal_title">Filter Assessments Done</h2>
          ...
          <div class="full_width">
            <div class="form_group autocomplete">
              <label class="form_label" for="filter_career">Career Path</label>
              <v-autocomplete
                :items="filter_careers"
                id="filter_career"
                hide-details="auto"
                solo
                clearable
