<template>
  ...
  <div class="list_of_questions" v-if="questions">
    <div class="single_quiz_grid" v-for="question in questions">
      <template v-if="question.question_additional_information && question.question_additional_information.length > 0">
        <div class="text_sheet">
          <p v-for="info in question.question_additional_information" v-html="info.paragraph"></p>
        </div>
      </template>
