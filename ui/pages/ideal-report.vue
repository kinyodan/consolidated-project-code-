  ...
  <div>
    <client-only>
      <div class="text_center">
        <a class="page_cta" href="javascript:void(0)" @click="triggerPDF()">Download Report</a>
        <br> <br>
      </div>
...
export default {
  ...
  methods: {
    triggerPDF(){
     let w=window.open(`${process.env.WEBSITEURL}/ideal-report-printable?profile=${this.activeSlot}`,"_blank");
      /*setTimeout(()=>{
        w.print();
        w.close()},3000);*/
    },
