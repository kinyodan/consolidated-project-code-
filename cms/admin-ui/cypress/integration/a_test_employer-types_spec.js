...
describe('Testing Employer types page ', () => {
  ...
  it("LOGIN: to preserve token and navigate to Dashboard pathways and then to employer_types page", ()=>{
    ...
    //
    //
    // click access Add new Employer types ..
                ...
                cy.get('.b-table tr > td').first().each( (item , index) =>{
                    ...
                    .wrap(item)
                      ...
                      cy.get('.etd-name').first()
                          .should( 'have.attr', 'href', "/pathways/employer_types/new-employertype/?id=2")

                      cy.get('.etd-active').first()
                        .should('have.attr', 'href', "/pathways/employer_types/employer-type?id=2")
                      ...
                      cy.get('[data-id="Cypress-test-item-employer-type"]').click()
                      cy.wait(1000);
                      cy.get('[data-delete="Cypress-test-item-employer-type"]').click({force: true})
