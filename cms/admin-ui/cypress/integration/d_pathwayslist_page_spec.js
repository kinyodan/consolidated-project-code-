/*
describe('Testing Pathways page ', () => {
  ...
  it("LOGIN: to preserve token and navigate to Dashboard pathways and then to pathwys list page", ()=>{
    ...
    //
    // click access assesment ..
    cy.contains('Add new Pathways').click();
    cy.wait(6000);
    ...
    // ####################  START opening Add new pathway view in sequence and autofill form     
    //
    //
    // Get form inputs and autifill values 

     cy.get('input[name="Name"]') // 4.
            .type('Cypress-test-item-Pathway') // 5
    
     cy.get('.ck-editor__editable') // 4.
            .type('DESCRIPTION: Cypress test item Pathway') // 5
    ...
    //
    //
    // ###################  END opening Add new pathway view in sequence and autofill form     
                ...
                cy.get('.b-table tr > td').first().each( (item , index) =>{
                    ...
                    .wrap(item)
                      ...
                      cy.get('.etd-name').first()
                          .should('have.attr', 'href', "/pathways/pathways/new-pathway/?id=1");
                      ...
                      cy.get('[data-id="Cypress-test-item-Pathway"]').click()
                      cy.wait(1000);
                      cy.get('[data-delete="Cypress-test-item-Pathway"]').click({force: true})
