        ...
        <div class="sidebar sidebar-dark sidebar-fixed" id="sidebar">
          ...
          <ul class="sidebar-nav" data-coreui="navigation" data-simplebar>
            <li class="nav-item"><a class="nav-link" href="index.html">
              <svg class="nav-icon">
                <use xlink:href="https://cdn.jsdelivr.net/npm/@coreui/icons/sprites/free.svg#cil-speedometer"></use>
            ...
            <li class="nav-item"><a class="nav-link" href="typography.html">
              <svg class="nav-icon">
                <use xlink:href="https://cdn.jsdelivr.net/npm/@coreui/icons/sprites/free.svg#cil-pencil"></use>
              </svg> Typography</a></li>
            ...
            <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
              <svg class="nav-icon">
                <use xlink:href="https://cdn.jsdelivr.net/npm/@coreui/icons/sprites/free.svg#cil-cursor"></use>
              </svg> Buttons</a>
              <ul class="nav-group-items">
            ...
            <li class="nav-item"><a class="nav-link" href="charts.html">
              <svg class="nav-icon">
                <use xlink:href="https://cdn.jsdelivr.net/npm/@coreui/icons/sprites/free.svg#cil-chart-pie"></use>
              </svg> Charts</a></li>
            <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
              <svg class="nav-icon">
                <use xlink:href="https://cdn.jsdelivr.net/npm/@coreui/icons/sprites/free.svg#cil-notes"></use>
              </svg> Forms</a>
              <ul class="nav-group-items">
            ...
            <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
              <svg class="nav-icon">
                <use xlink:href="https://cdn.jsdelivr.net/npm/@coreui/icons/sprites/free.svg#cil-star"></use>
              </svg> Icons</a>
              <ul class="nav-group-items">
            ...
            <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
              <svg class="nav-icon">
                <use xlink:href="https://cdn.jsdelivr.net/npm/@coreui/icons/sprites/free.svg#cil-bell"></use>
              </svg> Notifications</a>
              <ul class="nav-group-items">
            ...
            <li class="nav-item"><a class="nav-link" href="widgets.html">
              <svg class="nav-icon">
                <use xlink:href="https://cdn.jsdelivr.net/npm/@coreui/icons/sprites/free.svg#cil-calculator"></use>
            ...
            <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
              ...
              <ul class="nav-group-items">
                ...
                <li class="nav-item"><a class="nav-link" href="404.html" target="_top">
                  <svg class="nav-icon">
                    <use xlink:href="https://cdn.jsdelivr.net/npm/@coreui/icons/sprites/free.svg#cil-bug"></use>
                  </svg> Error 404</a></li>
            ...
            <li class="nav-item mt-auto"><a class="nav-link" href="docs.html">
              <svg class="nav-icon">
                <use xlink:href="https://cdn.jsdelivr.net/npm/@coreui/icons/sprites/free.svg#cil-description"></use>
              </svg> Docs</a></li>
            <li class="nav-item"><a class="nav-link nav-link-danger" href="https://coreui.io/pro/" target="_top">
              <svg class="nav-icon">
                <use xlink:href="https://cdn.jsdelivr.net/npm/@coreui/icons/sprites/free.svg#cil-layers"></use>
              </svg> Try CoreUI
          ...
          <header class="header header-sticky mb-4">
            <div class="container-fluid">
              ...
              <ul class="header-nav ms-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="#">
                  <svg class="icon icon-lg">
                    <use xlink:href="https://cdn.jsdelivr.net/npm/@coreui/icons/sprites/free.svg#cil-list-rich"></use>
                  </svg></a></li>
                <li class="nav-item"><a class="nav-link" href="#">
                  <svg class="icon icon-lg">
                    <use xlink:href="https://cdn.jsdelivr.net/npm/@coreui/icons/sprites/free.svg#cil-envelope-open"></use>
                  </svg></a></li>
              </ul>
              <ul class="header-nav ms-3">
                <li class="nav-item dropdown"><a class="nav-link py-0" data-coreui-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                  ...
                  <div class="dropdown-menu dropdown-menu-end pt-0">
                    ...
                    <svg class="icon me-2">
                      <use xlink:href="https://cdn.jsdelivr.net/npm/@coreui/icons/sprites/free.svg#cil-task"></use>
                    </svg> Tasks<span class="badge badge-sm bg-danger ms-2">42</span></a><a class="dropdown-item" href="#">
                    <svg class="icon me-2">
                      <use xlink:href="https://cdn.jsdelivr.net/npm/@coreui/icons/sprites/free.svg#cil-comment-square"></use>
                    ...
                    <svg class="icon me-2">
                      <use xlink:href="https://cdn.jsdelivr.net/npm/@coreui/icons/sprites/free.svg#cil-credit-card"></use>
                    </svg> Payments<span class="badge badge-sm bg-secondary ms-2">42</span></a><a class="dropdown-item" href="#">
                    <svg class="icon me-2">
                      <use xlink:href="https://cdn.jsdelivr.net/npm/@coreui/icons/sprites/free.svg#cil-file"></use>
            ...
            <div class="container-fluid">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb my-0 ms-2">
                  ...
                  <li class="breadcrumb-item active"><span>Navs</span></li>
                </ol>
              </nav>
            </div>
          </header>
          <div class="body flex-grow-1 px-3">
            <div class="container-lg">
              <div class="callout callout-info bg-white">CoreUI Navs has been created as an extension of Bootstrap Navs. Navs is delivered with some new features, variants, and unique design that matches CoreUI Design System requirements.<br><br>For more information please visit our official
                <a href="https://coreui.io/docs/components/navs-tabs/" target="_blank">documentation</a>.
              </div>
              <div class="row">
                <div class="col-12">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      ...
                      <div class="example">
                        <ul class="nav nav-tabs" role="tablist">
                          <li class="nav-item"><a class="nav-link active" data-coreui-toggle="tab" href="#preview-516" role="tab">
                            <svg class="icon me-2">
                              <use xlink:href="https://cdn.jsdelivr.net/npm/@coreui/icons/sprites/free.svg#cil-media-play"></use>
                            </svg>Preview</a></li>
                          <li class="nav-item"><a class="nav-link" href="https://coreui.io/docs/components/navs-tabs/#base-nav" target="_blank">
                            <svg class="icon me-2">
                              <use xlink:href="https://cdn.jsdelivr.net/npm/@coreui/icons/sprites/free.svg#cil-code"></use>
                            </svg>Code</a></li>
                        </ul>
                        <div class="tab-content rounded-bottom">
                          <div class="tab-pane p-3 active preview" role="tabpanel" id="preview-516">
                            <ul class="nav">
                      ...
                      <div class="example">
                        <ul class="nav nav-tabs" role="tablist">
                          <li class="nav-item"><a class="nav-link active" data-coreui-toggle="tab" href="#preview-1042" role="tab">
                            <svg class="icon me-2">
                              <use xlink:href="https://cdn.jsdelivr.net/npm/@coreui/icons/sprites/free.svg#cil-media-play"></use>
                            </svg>Preview</a></li>
                          <li class="nav-item"><a class="nav-link" href="https://coreui.io/docs/components/navs-tabs/#base-nav" target="_blank">
                        ...
                        <div class="tab-content rounded-bottom">
                          <div class="tab-pane p-3 active preview" role="tabpanel" id="preview-1042">
                ...
                <div class="col-12">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      ...
                      <div class="example">
                        <ul class="nav nav-tabs" role="tablist">
                          <li class="nav-item"><a class="nav-link active" data-coreui-toggle="tab" href="#preview-153" role="tab">
                            <svg class="icon me-2">
                              <use xlink:href="https://cdn.jsdelivr.net/npm/@coreui/icons/sprites/free.svg#cil-media-play"></use>
                            </svg>Preview</a></li>
                          <li class="nav-item"><a class="nav-link" href="https://coreui.io/docs/components/navs-tabs/#horizontal-alignment" target="_blank">
                        ...
                        <div class="tab-content rounded-bottom">
                          <div class="tab-pane p-3 active preview" role="tabpanel" id="preview-153">
                ...
                <div class="col-12">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      ...
                      <div class="example">
                        <ul class="nav nav-tabs" role="tablist">
                          <li class="nav-item"><a class="nav-link active" data-coreui-toggle="tab" href="#preview-896" role="tab">
                            <svg class="icon me-2">
                              <use xlink:href="https://cdn.jsdelivr.net/npm/@coreui/icons/sprites/free.svg#cil-media-play"></use>
                            </svg>Preview</a></li>
                        ...
                        <div class="tab-content rounded-bottom">
                          <div class="tab-pane p-3 active preview" role="tabpanel" id="preview-896">
                ...
                <div class="col-12">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      ...
                      <div class="example">
                        <ul class="nav nav-tabs" role="tablist">
                          <li class="nav-item"><a class="nav-link active" data-coreui-toggle="tab" href="#preview-143" role="tab">
                            <svg class="icon me-2">
                              <use xlink:href="https://cdn.jsdelivr.net/npm/@coreui/icons/sprites/free.svg#cil-media-play"></use>
                            </svg>Preview</a></li>
                        ...
                        <div class="tab-content rounded-bottom">
                          <div class="tab-pane p-3 active preview" role="tabpanel" id="preview-143">
                ...
                <div class="col-12">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      ...
                      <div class="example">
                        <ul class="nav nav-tabs" role="tablist">
                          <li class="nav-item"><a class="nav-link active" data-coreui-toggle="tab" href="#preview-1029" role="tab">
                            <svg class="icon me-2">
                              <use xlink:href="https://cdn.jsdelivr.net/npm/@coreui/icons/sprites/free.svg#cil-media-play"></use>
                            </svg>Preview</a></li>
                        ...
                        <div class="tab-content rounded-bottom">
                          <div class="tab-pane p-3 active preview" role="tabpanel" id="preview-1029">
                ...
                <div class="col-12">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      ...
                      <div class="example">
                        <ul class="nav nav-tabs" role="tablist">
                          <li class="nav-item"><a class="nav-link active" data-coreui-toggle="tab" href="#preview-1166" role="tab">
                            <svg class="icon me-2">
                              <use xlink:href="https://cdn.jsdelivr.net/npm/@coreui/icons/sprites/free.svg#cil-media-play"></use>
                            </svg>Preview</a></li>
                        ...
                        <div class="tab-content rounded-bottom">
                          <div class="tab-pane p-3 active preview" role="tabpanel" id="preview-1166">
                      ...
                      <div class="example">
                        <ul class="nav nav-tabs" role="tablist">
                          <li class="nav-item"><a class="nav-link active" data-coreui-toggle="tab" href="#preview-656" role="tab">
                            <svg class="icon me-2">
                              <use xlink:href="https://cdn.jsdelivr.net/npm/@coreui/icons/sprites/free.svg#cil-media-play"></use>
                            </svg>Preview</a></li>
                          <li class="nav-item"><a class="nav-link" href="https://coreui.io/docs/components/navs-tabs/#fill-and-justify" target="_blank">
                        ...
                        <div class="tab-content rounded-bottom">
                          <div class="tab-pane p-3 active preview" role="tabpanel" id="preview-656">
                      ...
                      <div class="example">
                        <ul class="nav nav-tabs" role="tablist">
                          <li class="nav-item"><a class="nav-link active" data-coreui-toggle="tab" href="#preview-443" role="tab">
                            <svg class="icon me-2">
                              <use xlink:href="https://cdn.jsdelivr.net/npm/@coreui/icons/sprites/free.svg#cil-media-play"></use>
                            </svg>Preview</a></li>
                          <li class="nav-item"><a class="nav-link" href="https://coreui.io/docs/components/navs-tabs/#fill-and-justify" target="_blank">
                        ...
                        <div class="tab-content rounded-bottom">
                          <div class="tab-pane p-3 active preview" role="tabpanel" id="preview-443">
                      ...
                      <div class="example">
                        <ul class="nav nav-tabs" role="tablist">
                          <li class="nav-item"><a class="nav-link active" data-coreui-toggle="tab" href="#preview-598" role="tab">
                            <svg class="icon me-2">
                              <use xlink:href="https://cdn.jsdelivr.net/npm/@coreui/icons/sprites/free.svg#cil-media-play"></use>
                            </svg>Preview</a></li>
                          <li class="nav-item"><a class="nav-link" href="https://coreui.io/docs/components/navs-tabs/#fill-and-justify" target="_blank">
                        ...
                        <div class="tab-content rounded-bottom">
                          <div class="tab-pane p-3 active preview" role="tabpanel" id="preview-598">
                ...
                <div class="col-12">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      ...
                      <div class="example">
                        <ul class="nav nav-tabs" role="tablist">
                          <li class="nav-item"><a class="nav-link active" data-coreui-toggle="tab" href="#preview-43" role="tab">
                            <svg class="icon me-2">
                              <use xlink:href="https://cdn.jsdelivr.net/npm/@coreui/icons/sprites/free.svg#cil-media-play"></use>
                            </svg>Preview</a></li>
                        ...
                        <div class="tab-content rounded-bottom">
                          <div class="tab-pane p-3 active preview" role="tabpanel" id="preview-43">
  ...
  head(){
    return{
      ...
      link: [
        ...
        { rel:"apple-touch-icon" ,sizes:"114x114" ,ref:"assets/favicon/apple-icon-114x114.png"},
        { rel:"apple-touch-icon" ,sizes:"120x120" ,ref:"assets/favicon/apple-icon-120x120.png"},
        ...
        { rel:"stylesheet" ,href:"node_modules/simplebar/dist/simplebar.css"},
        { rel:"stylesheet", href:"css/vendors/simplebar.css"},
        { ref:"css/style.css" ,rel:"stylesheet"},
        { rel:"stylesheet" , href:"https://cdn.jsdelivr.net/npm/prismjs@1.23.0/themes/prism.css"},
        { ref:"css/examples.css", rel:"stylesheet"}
      ]
    }
  },
  mounted() {
